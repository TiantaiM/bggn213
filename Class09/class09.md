...
Here we examine data from 569 patient data.

``` r
x <- table(wisc.df$diagnosis)
```

In this dataset we have 357 cancer patients and 212 non\_cancer patident
...
```
    ...
    ## Metric: 'euclidean'; comparing: 569 vectors.
